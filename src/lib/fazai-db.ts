...
const DEFAULT_ACCOUNTS: Account[] = [
  ...
  { id: 'acc-cash', code: '1-1000', name: 'Cash on Hand', nameId: 'Kas', nameZh: '库存现金', type: 'asset', parentId: 'acc-asset-root', isSystem: true, isActive: true, createdAt: new Date() },
  { id: 'acc-bank', code: '1-2000', name: 'Bank Account', nameId: 'Rekening Bank', nameZh: '银行账户', type: 'asset', parentId: 'acc-asset-root', isSystem: true, isActive: true, createdAt: new Date() },
